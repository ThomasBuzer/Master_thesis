...
def train_test(build_dir, batchsize, learnrate, epochs, target_number, model_path):
    ...
    x_test = build_dir + "../weights_1byte/x_test.npy"
    y_test = build_dir + "/y_test.npy"

    x_train = build_dir + "../weights_1byte/x_train.npy"
    ...
    for epoch in tqdm(range(1, epochs + 1)):
        ...
        train(model, device, train_loader, optimizer, epoch, noise_amplitude=0, bit=target_number)
        test(model, device, test_loader, bit=target_number)
