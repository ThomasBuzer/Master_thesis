set_property PACKAGE_PIN D5 [get_ports {leds_4bits_tri_o[0]}];
set_property PACKAGE_PIN D6 [get_ports {leds_4bits_tri_o[1]}];
set_property PACKAGE_PIN A5 [get_ports {leds_4bits_tri_o[2]}];
set_property PACKAGE_PIN B5 [get_ports {leds_4bits_tri_o[3]}];
