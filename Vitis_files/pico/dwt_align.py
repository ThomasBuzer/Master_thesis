...
if __name__=="__main__":
    ...
    start = 8000#50000                     #Start of the segement to align from reference trace
    end = 33000#150000                     #End of the segement to align from reference trace
    threshold = 0.7               #The minimum correlation expected to consider the alignment successful
    max_shift = 3000               #The maximum shift allowed.
